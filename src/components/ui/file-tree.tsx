...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "absolute left-1.5 h-full w-px rounded-md bg-muted py-3 duration-300 ease-in-out hover:bg-rose-300 rtl:right-1.5",
        className
      )}
      {...props}
    />
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            ...
            className,
            {
              "bg-rose-500 rounded-md": isSelect && isSelectable,
    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-rose-500": isSelected && isSelectable,
          },
